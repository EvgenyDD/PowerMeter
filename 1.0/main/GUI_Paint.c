...
void Paint_DrawChar(uint16_t Xpoint, uint16_t Ypoint, const char Acsii_Char,
					sFONT_t *Font, uint16_t Color_Foreground, uint16_t Color_Background)
{
...
void Paint_DrawNum(uint16_t Xpoint, uint16_t Ypoint, double Nummber,
				   sFONT_t *Font, uint16_t Digit, uint16_t Color_Foreground, uint16_t Color_Background)
{
	char Str[ARRAY_LEN];
...
parameter:
	...
	Color_Background : Select the background color
******************************************************************************/
void Paint_DrawTime(uint16_t Xstart, uint16_t Ystart, PAINT_TIME *pTime, sFONT_t *Font,
					uint16_t Color_Foreground, uint16_t Color_Background)
{
